...
1. Install Homebox either by using [the latest Docker image](./installation#docker), or by downloading the correct executable for your Operating System from the [Releases](https://github.com/pbulteel/homebox-justfind/releases). (See [Installation](./installation) for more details)
